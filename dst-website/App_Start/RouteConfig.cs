namespace dst_website
{
    ...
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("menu-top", "menu/top", new {area = string.Empty, controller = "SiteMap", action = "Index"},
                            new[] {"dst_website.Controllers"});
            ...
            routes.MapRoute("blog-last", "blog/last", new {area = string.Empty, controller = "Blog", action = "Last"},
                            new[] {"dst_website.Controllers"});
            routes.MapRoute("blog-categories", "blog/categories",
                            new {area = string.Empty, controller = "Blog", action = "GetCategories"},
                            new[] {"dst_website.Controllers"});
            routes.MapRoute("blog-feed", "blog/feed", new {area = string.Empty, controller = "Blog", action = "Feed"},
                            new[] {"dst_website.Controllers"});
        }
    }
}