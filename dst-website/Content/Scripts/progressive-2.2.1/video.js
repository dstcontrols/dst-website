...
(function() {
    ...
    u.Db = function(a, c) { c.firstChild ? c.insertBefore(a, c.firstChild) : c.appendChild(a); };
    u.Na = {};
    u.w = function(a) {
        0 === a.indexOf("#") && (a = a.slice(1));
    ...
    u.Td = function() { document.onselectstart = r(f); };
    ...
    u.get = function(a, c, d, e) {
        ...
        k.protocol + k.host !== p.protocol + p.host && window.XDomainRequest && !("withCredentials" in
            h) ? (h = new window.XDomainRequest, h.onload = function() { c(h.responseText); }, h.onerror = d, h.onprogress = m(), h.ontimeout = d) : (g = "file:" == k.protocol || "file:" == p.protocol, h.onreadystatechange = function() { 4 === h.readyState && (200 === h.status || g && 0 === h.status ? c(h.responseText) : d(h.responseText)); });
        try {
    ...
    t.c = f;
    t.m = q("c");
    t.options = function(a) { return a === b ? this.j : this.j = u.oa.Jb(this.j, a); };
    ...
    t.name = q("wd");
    t.children = q("N");
    t.qd = function(a) { return this.Oa[a]; };
    ...
    t.uc = function() {
        ...
        if (c = this.options().children)
            if (c instanceof Array)for (var g = 0; g < c.length; g++)d = c[g], "string" == typeof d ? (e = d, d = {}) : e = d.name, a[e] = a.V(e, d);
    ...
    t.e = function(a, c) {
        ...
        c.innerHTML || (this.u = u.e("div", { className: "vjs-control-content" }), this.wb = u.e("span", { className: "vjs-control-text", innerHTML: this.sa || "Need Text" }), this.u.appendChild(this.wb), d.appendChild(this.u));
        return d;
    };
    ...
    u.I.prototype.e = function(a, c) { return u.s.prototype.e.call(this, "li", u.l.B({ className: "vjs-menu-item", innerHTML: this.j.label }, c)); };
    u.I.prototype.q = function() { this.selected(f); };
    u.I.prototype.selected = function(a) { a ? (this.o("vjs-selected"), this.b.setAttribute("aria-selected", f)) : (this.r("vjs-selected"), this.b.setAttribute("aria-selected", l)); };
    u.L = u.s.extend({
        h: function(a, c) {
            u.s.call(this, a, c);
            this.za = this.va();
    ...
    t.va = function() {
        ...
        this.options().title && a.ia().appendChild(u.e("li", { className: "vjs-menu-title", innerHTML: u.$(this.options().title), Rd: -1 }));
    ...
    u.Player = u.a.extend({
        h: function(a, c, d) {
            ...
            u.Aa[this.T] = this;
            c.plugins && u.l.wa(c.plugins, function(a, c) { this[a](c); }, this);
            var e, g, h, k, p, n;
            ...
            this.d("keydown", e);
            this.d("keyup", e);
            h = setInterval(u.bind(this, function() { this.na && (this.na = l, this.userActive(f), clearTimeout(k), k = setTimeout(u.bind(this, function() { this.na || this.userActive(l); }), 2E3)); }), 250);
    ...
    t.Kc = function() {
        this.lc && this.Ba();
        this.lc = setInterval(u.bind(this, function() { this.k("timeupdate"); }), 250);
    };
    t.Ba = function() {
    ...
    t.Bd = function() {
        this.error(j);
        this.paused() ? (T(this, l), this.W("play", function() { T(this, f); })) : this.k("firstplay");
    };
    t.tc = l;

    function T(a, c) { c !== b && a.tc !== c && ((a.tc = c) ? (a.o("vjs-has-started"), a.k("firstplay")) : a.r("vjs-has-started")); }
    ...
    t.Cd = function() { 1 == this.bufferedPercent() && this.k("loadedalldata"); };
    t.xd = function() { this.j.loop && (this.currentTime(0), this.play()); };
    t.yc = function() {
        var a = U(this, "duration");
        a && (0 > a && (a = Infinity), this.duration(a), Infinity === a ? this.o("vjs-live") : this.r("vjs-live"));
    };
    t.Ad = function() { this.isFullscreen() ? this.o("vjs-fullscreen") : this.r("vjs-fullscreen"); };

    function V(a, c, d) {
        if (a.g && !a.g.ca)a.g.J(function() { this[c](d); });
        else
            try {
                a.g[c](d);
            } catch (e) {
    ...
    t.currentTime = function(a) { return a !== b ? (V(this, "setCurrentTime", a), this.Ib && this.k("timeupdate"), this) : this.z.currentTime = U(this, "currentTime") || 0; };
    ...
    t.pc = function(a) { 27 === a.keyCode && (this.isFullscreen() === f ? this.exitFullscreen() : ea(this)); };
    ...
    t.src = function(a) {
        ...
        if (a instanceof Array) {
            ...
            c ? (a = c.source, c = c.g, c == this.Ca ? this.src(a) : R(this, c, a)) : (this.error({ code: 4, message: this.options().notSupportedMessage }),
                this.Ea());
        } else a instanceof Object ? window.videojs[this.Ca].canPlaySource(a) ? this.src(a.src) : this.src([a]) : (this.z.src = a, this.ca ? (V(this, "src", a), "auto" == this.j.preload && this.load(), this.j.autoplay && this.play()) : this.J(function() { this.src(a); }));
        return this;
    };
    t.load = function() {
        V(this, "load");
    ...
    t.controls = function(a) { return a !== b ? (a = !!a, this.xb !== a && ((this.xb = a) ? (this.r("vjs-controls-disabled"), this.o("vjs-controls-enabled"), this.k("controlsenabled")) : (this.r("vjs-controls-enabled"), this.o("vjs-controls-disabled"), this.k("controlsdisabled"))), this) : this.xb; };
    u.Player.prototype.Sb;
    t = u.Player.prototype;
    t.usingNativeControls = function(a) { return a !== b ? (a = !!a, this.Sb !== a && ((this.Sb = a) ? (this.o("vjs-using-native-controls"), this.k("usingnativecontrols")) : (this.r("vjs-using-native-controls"), this.k("usingcustomcontrols"))), this) : this.Sb; };
    t.ba = j;
    t.error = function(a) {
    ...
    u.Ha = u.a.extend();
    u.Ha.prototype.j = { ee: "play", children: { playToggle: {}, currentTimeDisplay: {}, timeDivider: {}, durationDisplay: {}, remainingTimeDisplay: {}, liveDisplay: {}, progressControl: {}, fullscreenToggle: {}, volumeControl: {}, muteToggle: {}, playbackRateMenuButton: {} } };
    u.Ha.prototype.e = function() { return u.e("div", { className: "vjs-control-bar" }); };
    u.Yb = u.a.extend({ h: function(a, c) { u.a.call(this, a, c); } });
    ...
    u.gc = u.a.extend({ h: function(a, c) { u.a.call(this, a, c); } });
    u.gc.prototype.e = function() { return u.a.prototype.e.call(this, "div", { className: "vjs-time-divider", innerHTML: "<div><span>/</span></div>" }); };
    u.mb = u.a.extend({
        h: function(a, c) {
            u.a.call(this, a, c);
            a.d("timeupdate", u.bind(this, this.fa));
    ...
    u.mb.prototype.fa = function() { this.c.duration() && (this.u.innerHTML = '<span class="vjs-control-text">Remaining Time </span>-' + u.ya(this.c.duration() - this.c.currentTime())); };
    ...
    u.Ia.prototype.q = function() { this.c.isFullscreen() ? (this.c.exitFullscreen(), this.wb.innerHTML = "Fullscreen") : (this.c.requestFullscreen(), this.wb.innerHTML = "Non-Fullscreen"); };
    u.lb = u.a.extend({ h: function(a, c) { u.a.call(this, a, c); } });
    u.lb.prototype.j = { children: { seekBar: {} } };
    u.lb.prototype.e = function() { return u.a.prototype.e.call(this, "div", { className: "vjs-progress-control vjs-control" }); };
    u.cc = u.Q.extend({
        h: function(a, c) {
            u.Q.call(this, a, c);
    ...
    t.Cb = function() { return this.c.currentTime() / this.c.duration(); };
    t.Wa = function(a) {
    ...
    u.ib.prototype.e = function() { return u.a.prototype.e.call(this, "div", { className: "vjs-load-progress", innerHTML: '<span class="vjs-control-text">Loaded: 0%</span>' }); };
    u.ib.prototype.update = function() { this.b.style && (this.b.style.width = u.round(100 * this.c.bufferedPercent(), 2) + "%"); };
    u.$b = u.a.extend({ h: function(a, c) { u.a.call(this, a, c); } });
    u.$b.prototype.e = function() { return u.a.prototype.e.call(this, "div", { className: "vjs-play-progress", innerHTML: '<span class="vjs-control-text">Progress: 0%</span>' }); };
    u.Ka = u.Y.extend({
        h: function(a, c) {
            u.Y.call(this, a, c);
            a.d("timeupdate", u.bind(this, this.fa));
    ...
    u.ob.prototype.j = { children: { volumeBar: {} } };
    u.ob.prototype.e = function() { return u.a.prototype.e.call(this, "div", { className: "vjs-volume-control vjs-control" }); };
    u.nb = u.Q.extend({
        h: function(a, c) {
            u.Q.call(this, a, c);
    ...
    t.Cb = function() { return this.c.muted() ? 0 : this.c.volume(); };
    ...
    u.hc.prototype.e = function() { return u.a.prototype.e.call(this, "div", { className: "vjs-volume-level", innerHTML: '<span class="vjs-control-text"></span>' }); };
    u.pb = u.Y.extend();
    u.pb.prototype.defaultValue = "00:00";
    u.pb.prototype.e = function() { return u.Y.prototype.e.call(this, "div", { className: "vjs-volume-handle" }); };
    u.ha = u.s.extend({
        h: function(a, c) {
            u.s.call(this, a, c);
    ...
    u.qa.prototype.va = function() {
        var a = new u.ga(this.c, { kc: "div" }), c = new u.nb(this.c, u.l.B({ Vd: f }, this.j.le));
        a.V(c);
        return a;
    };
    ...
    t.va = function() {
        ...
        if (c)for (var d = c.length - 1; 0 <= d; d--)a.V(new u.kb(this.m(), { rate: c[d] + "x" }));
        return a;
    };
    ...
    u.kb.prototype.update = function() { this.selected(this.m().playbackRate() == this.Cc); };
    u.Ja = u.s.extend({
        h: function(a, c) {
            u.s.call(this, a, c);
    ...
    u.Zb.prototype.e = function() { return u.a.prototype.e.call(this, "div", { className: "vjs-loading-spinner" }); };
    u.bb = u.s.extend();
    u.bb.prototype.e = function() { return u.s.prototype.e.call(this, "div", { className: "vjs-big-play-button", innerHTML: '<span aria-hidden="true"></span>', "aria-label": "play video" }); };
    u.bb.prototype.q = function() { this.c.play(); };
    u.gb = u.a.extend({
        h: function(a, c) {
            u.a.call(this, a, c);
            this.update();
    ...
    u.t = u.a.extend({
        h: function(a, c, d) {
            ...
            this.J(function() { this.networkState && 0 < this.networkState() && this.m().k("loadstart"); });
        }
    });
    t = u.t.prototype;
    t.Hd = function() {
    ...
    t.Dd = function() { this.m().userActive(!this.m().userActive()); };
    t.Pb = m();
    ...
    u.f = u.t.extend({
        h: function(a, c, d) {
            ...
            a.J(function() { this.P && (this.j.autoplay && this.paused()) && (delete this.P.poster, this.play()); });
            this.Ea();
        }
    });
    t = u.f.prototype;
    ...
    t.e = function() {
        ...
        if (!c || this.n.movingMediaElementInDOM === l)c ? (d = c.cloneNode(l), u.f.mc(c), c = d, a.P = j) : c = u.e("video", { id: a.id() + "_html5_api", className: "vjs-tech" }), c.player = a, u.Db(c, a.w());
    ...
    t.Pd = function(a) { this.b.volume = a; };
    t.muted = function() { return this.b.muted; };
    t.Md = function(a) { this.b.muted = a; };
    ...
    t.Nd = function(a) { this.b.playbackRate = a; };
    t.networkState = function() { return this.b.networkState; };
    ...
    u.f.zc = function() {
        4 <= u.Tb && (W || (W = u.A.constructor.prototype.canPlayType), u.A.constructor.prototype.canPlayType = function(a) { return a && ha.test(a) ? "maybe" : W.call(this, a); });
        u.Wc && (W || (W = u.A.constructor.prototype.canPlayType), u.A.constructor.prototype.canPlayType = function(a) { return a && ia.test(a) ? "maybe" : W.call(this, a); });
    };
    u.f.Ud = function() {
    ...
    t.Pb = m();
    t.buffered = function() { return u.yb(0, this.b.vjs_getProperty("buffered")); };
    t.ab = r(l);
    t.nc = r(l);
    ...
    function ma(a) { ja[a] = function() { return this.b.vjs_getProperty(a); }; }
    ...
    u.i.ub = function(a) { a.w().vjs_getProperty ? a.Ea() : setTimeout(function() { u.i.ub(a); }, 50); };
    ...
    u.i.Qd = function(a, c) { return a + "&" + c; };
    u.i.Ic = function(a) {
        var c = { vb: "", Qb: "" };
        if (!a)return c;
        var d = a.indexOf("&"), e;
    ...
    u.i.ud = function(a) { return a in u.i.Jc; };
    u.i.Yc = /^rtmp[set]?:\/\//i;
    u.i.td = function(a) { return u.i.Yc.test(a); };
    u.Xc = u.a.extend({
        h: function(a, c, d) {
            u.a.call(this, a, c, d);
    ...
    function na(a, c, d, e, g) {
        ...
        h.push(k);
        k.Qa() && a.J(function() { setTimeout(function() { k.show(); }, 0); });
    }
    ...
    t.load = function() { 0 === this.la && (this.la = 1, u.get(this.Fc, u.bind(this, this.Ed), u.bind(this, this.yd))); };
    t.yd = function(a) {
        this.error = a;
        this.la = 3;
        this.k("error");
            ...
            if (this.Ob === b || a < this.Ob || this.Ta <= a) {
                ...
                for (;;) {
                    ...
                    if (n.xa <= a)e = Math.max(e, n.xa), n.Ma && (n.Ma = l);
                        ...
                        g ? (h.splice(0, 0, n), p === b && (p = s), k = s) : (h.push(n), k === b && (k = s), p = s), d = Math.min(d,
    ...
    u.fc.prototype.e = function() { return u.a.prototype.e.call(this, "div", { className: "vjs-text-track-display" }); };
    u.Z = u.I.extend({
        h: function(a, c) {
    ...
    u.jb = u.Z.extend({
        h: function(a, c) {
            c.track = { K: function() { return c.kind; }, m: a, label: function() { return c.kind + " off"; }, Qa: r(l), mode: r(l) };
            u.Z.call(this, a, c);
            this.selected(f);
        }
    });
    ...
    u.U.prototype.ua = function() {
        var a = [], c;
        a.push(new u.jb(this.c, { kind: this.H }));
    ...
    t.va = function() {
        ...
        a.ia().appendChild(u.e("li", { className: "vjs-menu-title", innerHTML: u.$(this.H), Rd: -1 }));
        if (g) {
            e = g.aa;
            for (var k, c = 0, d = e.length; c < d; c++)k = e[c], k = new u.cb(this.c, { track: g, cue: k }), h.push(k), a.V(k);
        }
    ...
    u.rb = function() { setTimeout(u.ic, 1); };
    "complete" === document.readyState ? u.Oc = f : u.W(window, "load", function() { u.Oc = f; });
    u.rb();
    u.Gd = function(a, c) { u.Player.prototype[a] = c; };
    var ra = this;
    ra.Xd = f;
